...
### Fixed
- Fixed ydotool setup: postinst now auto-creates systemd service for ydotoold daemon
- Added `xdotool` dependency for X11 paste support (previously only ydotool for Wayland was included)
